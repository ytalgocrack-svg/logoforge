                ...
                <div className="relative" ref={dropdownRef}>
                  ...
                  >
                    <div className="w-10 h-10 rounded-full bg-gradient-to-tr from-primary to-purple-500 p-[2px]">
                      {/* Safety Check: Only try to load image if profile exists, else fallback to initials */}
                      {profile?.avatar_url ? (
                        <img 
                        ...
                        <div className="w-full h-full rounded-full bg-[#0f172a] flex items-center justify-center text-white font-bold border-2 border-[#0f172a]">
                          {getInitials()}
                        </div>
                      )}
                    </div>
                      ...
                      <div className="py-2">
                        {isAdmin && (
                          <Link 
                            ...
                            className="flex items-center gap-3 px-4 py-2 text-sm text-red-400 hover:bg-white/5 hover:text-red-300"
                          >
